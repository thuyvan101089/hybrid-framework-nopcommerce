...
public class User_01_Register {
  ...
  public void TC_02_Register_Invalid_Email() {
	  ...
	  driver.findElement(By.cssSelector("#Email")).sendKeys("abcd@1234%%%%");
	  driver.findElement(By.cssSelector("#Password")).sendKeys("12345678");
	  driver.findElement(By.cssSelector("#ConfirmPassword")).sendKeys("12345678");
	  driver.findElement(By.cssSelector("button#register-button")).click();
 ...
 driver.findElement(By.cssSelector("a.ico-register")).click();
  ...
  public void TC_05_Register_Password_Less_Than_6_Characters() {
	  ...
	  driver.findElement(By.cssSelector("#ConfirmPassword")).sendKeys("1234");
	  driver.findElement(By.cssSelector("button#register-button")).click();
